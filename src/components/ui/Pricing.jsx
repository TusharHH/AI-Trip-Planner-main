...
export const PricingCard = ({ plan, loading, stripeReady }) => {
  return (
    <div className="flex flex-col h-full max-w-lg p-6 mx-auto text-center bg-white border rounded-lg shadow-lg dark:bg-gray-800 dark:text-white">
      ...
      <div className="flex-grow">
        ...
        {/* Optional form */}
        {plan.form && <div className="mb-4">{plan.form}</div>}
      </div>
      ...
      <button
        ...
        className="mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg px-5 py-2.5 text-center disabled:opacity-50 disabled:cursor-not-allowed"
      >
